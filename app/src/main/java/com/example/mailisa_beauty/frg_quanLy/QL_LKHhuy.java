...
public class QL_LKHhuy extends Fragment {

    public QL_LKHhuy() {
        // Required empty public constructor
    }
    RecyclerView rcvlkhbihuy;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_ql_lkhhuy, container, false);
        rcvlkhbihuy = view.findViewById(R.id.rcvlkhbihuy);

        taiKhoanDAO = new TaiKhoanDAO(getActivity());

        lichKhachHangDao = new LichKhachHang_DAO(getActivity());
        list = (ArrayList<LichKhachHang>) lichKhachHangDao.getAllByTrangThai("Bị hủy");
        LinearLayoutManager layout = new LinearLayoutManager(getActivity());
        rcvlkhbihuy.setLayoutManager(layout);
        lichKhachHang_ql_adapter = new LichKhachHang_QL_ADAPTER(getActivity(), list);
        rcvlkhbihuy.setAdapter(lichKhachHang_ql_adapter);
        return view;
    }
