...
public class QL_LKHchuaChapNhan extends Fragment {


    public QL_LKHchuaChapNhan() {
        // Required empty public constructor
    }


    RecyclerView rcvlkhchuachapnhan;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_ql_lkhchuachapnhan, container, false);
        rcvlkhchuachapnhan = view.findViewById(R.id.rcvlkhchuachapnhan);

        taiKhoanDAO = new TaiKhoanDAO(getActivity());

        lichKhachHangDao = new LichKhachHang_DAO(getActivity());
        list = (ArrayList<LichKhachHang>) lichKhachHangDao.getAllByTrangThai("Đang chờ");
        LinearLayoutManager layout = new LinearLayoutManager(getActivity());
        rcvlkhchuachapnhan.setLayoutManager(layout);
        lichKhachHang_ql_adapter = new LichKhachHang_QL_ADAPTER(getActivity(), list);
        rcvlkhchuachapnhan.setAdapter(lichKhachHang_ql_adapter);
        return view;
    }
