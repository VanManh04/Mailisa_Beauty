...
public class QL_LKHhoanThanh extends Fragment {

    public QL_LKHhoanThanh() {
        // Required empty public constructor
    }
    RecyclerView rcvlkhhoanthanh;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_ql_lkhhoanthanh, container, false);
        rcvlkhhoanthanh = view.findViewById(R.id.rcvlkhhoanthanh);

        taiKhoanDAO = new TaiKhoanDAO(getActivity());

        lichKhachHangDao = new LichKhachHang_DAO(getActivity());
        list = (ArrayList<LichKhachHang>) lichKhachHangDao.getAllByTrangThai("Hoàn thành");
        LinearLayoutManager layout = new LinearLayoutManager(getActivity());
        rcvlkhhoanthanh.setLayoutManager(layout);
        lichKhachHang_ql_adapter = new LichKhachHang_QL_ADAPTER(getActivity(), list);
        rcvlkhhoanthanh.setAdapter(lichKhachHang_ql_adapter);
        return view;
    }
