...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String data_DV = "INSERT INTO DichVu VALUES" +
                ...
                "(3,'img_2.png','LÀM ĐẸP DA NÁM BẰNG CÔNG NGHỆ CAO\n','16.000.000đ','PS','SALE','Mỗi quý khách hàng khi đến với Mailisa sẽ được đội ngũ chuyên viên kiểm tra để phân biệt nhận dạng, khách hàng đang bị nám gì để đưa ra phương pháp công nghệ cao phù hợp với từng làn da của từng khách hàng. Ví dụ khách hàng bị nám đinh chân sâu lâu năm hay là khách hàng bị tàn nhang hay là nám mảng cánh bướm lâu năm chân sâu hoặc là đồi mồi, bớt sắc tố'),"+
                ...
                "(5,'img_4.png','LÀM ĐẸP DA MỤN THÂM BẰNG CÔNG NGHỆ CAO\n','1.000.000đ','PS','SALE','Nguyên lý loại bỏ mụn bằng công nghệ Pixel CO2 tại Mailisa:\n" +
                ...
                "(6,'img_5.png','PHẪU THUẬT KHÂU TẠO HÌNH MẮT 2 MÍ\n','1.600.000đ','PS','NEW','“Khâu tạo hình mắt 2 mí” là một phương pháp tiểu phẫu nhưng cũng cần sự tinh tế và đòi hỏi tay nghề bác sĩ giỏi, có cặp mắt tinh tế và gu thẩm mỹ cao để xác định chính xác đường mí cần nhấn sao cho phù hợp với khuôn mặt và hốc mắt, giúp khách hàng trẻ trung, xinh đẹp. Thời gian thực hiện khoảng 20 - 30 phút'),"+
