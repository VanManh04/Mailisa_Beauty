...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String data_DV = "INSERT INTO DichVu VALUES" +
                "(1,'android.resource://com.example.mailisa_beauty/2131165507','LÀM ĐẦY RÃNH CƯỜI BABIES LINE','KHAC','SALE',12000000,10000000,'Rãnh cười chính là một đoạn nếp nhăn ở hai bên miệng, kéo dài từ cánh mũi chạy theo đường cong xuống tới cằm và nhìn rõ nhất khi cười.\n" +
                "\n" +
                ...
                "(2,'android.resource://com.example.mailisa_beauty/2131165344','CĂNG DA MẶT BÁN PHẦN FACE LIFT','PT','NEW',12000000,12000000,'Trước khi Căng da mặt mặt bán phần Face Lift tại Mailisa\n" +
                ...
                "(5,'android.resource://com.example.mailisa_beauty/2131165347','LÀM ĐẸP DA MỤN THÂM BẰNG CÔNG NGHỆ CAO','PS','SALE',2000000,1000000,'Nguyên lý loại bỏ mụn bằng công nghệ Pixel CO2 tại Mailisa:\n" +
                ...
                "(6,'android.resource://com.example.mailisa_beauty/2131165348','PHẪU THUẬT KHÂU TẠO HÌNH MẮT 2 MÍ','PS','NEW',1600000,1600000,'“Khâu tạo hình mắt 2 mí” là một phương pháp tiểu phẫu nhưng cũng cần sự tinh tế và đòi hỏi tay nghề bác sĩ giỏi, có cặp mắt tinh tế và gu thẩm mỹ cao để xác định chính xác đường mí cần nhấn sao cho phù hợp với khuôn mặt và hốc mắt, giúp khách hàng trẻ trung, xinh đẹp. Thời gian thực hiện khoảng 20 - 30 phút'),"+
                "(7,'android.resource://com.example.mailisa_beauty/2131165349','PHUN MÀY CHẠM HẠT SƯƠNG BAY','KHAC','KHONG',22000000,22000000,'Với phương châm “Trao Bạn Nét Đẹp Mà Tự Nhiên”, khi mỗi quý khách hàng đến với Mailisa sẽ được đội ngũ nhân viên chuyên môn cao, tay nghề giỏi tư vấn chọn màu, thiết kế vẽ mẫu phù hợp với từng khuôn mặt.\n" +
                "\n" +
        ...
        String data_LKH = "INSERT INTO LichKhachHang VALUES" +
                ...
                "(2,1,3,'2023/11/22','9:10','Tiền mặt','Xác nhận','','')," +
