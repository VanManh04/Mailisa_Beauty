...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String data_DV = "INSERT INTO DichVu VALUES" +
                "(1,'img.png','LÀM ĐẦY RÃNH CƯỜI BABIES LINE','20.000.000','PT','SALE','Rãnh cười chính là một đoạn nếp nhăn ở hai bên miệng, kéo dài từ cánh mũi chạy theo đường cong xuống tới cằm và nhìn rõ nhất khi cười.\n" +
                "\n" +
                ...
                "(2,'img_1.png','CĂNG DA MẶT BÁN PHẦN FACE LIFT\n','30.000.000','PT','NEW','Trước khi Căng da mặt mặt bán phần Face Lift tại Mailisa\n" +
                ...
                "(3,'img_2.png','LÀM ĐẸP DA NÁM BẰNG CÔNG NGHỆ CAO\n','20.000.000','PS','KHONG','Mỗi quý khách hàng khi đến với Mailisa sẽ được đội ngũ chuyên viên kiểm tra để phân biệt nhận dạng, khách hàng đang bị nám gì để đưa ra phương pháp công nghệ cao phù hợp với từng làn da của từng khách hàng. Ví dụ khách hàng bị nám đinh chân sâu lâu năm hay là khách hàng bị tàn nhang hay là nám mảng cánh bướm lâu năm chân sâu hoặc là đồi mồi, bớt sắc tố'),"+
                ...
                "(5,'img_4.png','LÀM ĐẸP DA MỤN THÂM BẰNG CÔNG NGHỆ CAO\n','800.000','PS','KHONG','Nguyên lý loại bỏ mụn bằng công nghệ Pixel CO2 tại Mailisa:\n" +
                ...
                "(6,'img_5.png','PHẪU THUẬT KHÂU TẠO HÌNH MẮT 2 MÍ\n','3.000.000','PS','KHONG','“Khâu tạo hình mắt 2 mí” là một phương pháp tiểu phẫu nhưng cũng cần sự tinh tế và đòi hỏi tay nghề bác sĩ giỏi, có cặp mắt tinh tế và gu thẩm mỹ cao để xác định chính xác đường mí cần nhấn sao cho phù hợp với khuôn mặt và hốc mắt, giúp khách hàng trẻ trung, xinh đẹp. Thời gian thực hiện khoảng 20 - 30 phút'),"+
                "(7,'img_6.png','PHUN MÀY CHẠM HẠT SƯƠNG BAY\n','400000','PS','KHONG','Với phương châm “Trao Bạn Nét Đẹp Mà Tự Nhiên”, khi mỗi quý khách hàng đến với Mailisa sẽ được đội ngũ nhân viên chuyên môn cao, tay nghề giỏi tư vấn chọn màu, thiết kế vẽ mẫu phù hợp với từng khuôn mặt.\n" +
                "\n" +
